class AppLocale {
  ...
  static const Map<String, Map<String, String>> languages = {
    'TR': {
      ...
      'transfer_flow': 'Aktarılan Debi (Q)',
      'transfer_success': 'Değer genleşme tankına aktarıldı.',
      'transfer_missing': 'Önce hidrofor hesabını yapın.',
    ...
    'EN': {
      ...
      'transfer_flow': 'Transferred Flow (Q)',
      'transfer_success': 'Value transferred to expansion tank.',
      'transfer_missing': 'Calculate hydrofor first.',
    ...
    'DE': {
      ...
      'transfer_flow': 'Übertragener Durchfluss (Q)',
      'transfer_success': 'Wert an Ausdehnungsgefäß übertragen.',
      'transfer_missing': 'Bitte zuerst Hydrofor berechnen.',
    ...
    'FR': {
      ...
      'transfer_flow': 'Débit transféré (Q)',
      'transfer_success': 'Valeur transférée au vase d\'expansion.',
      'transfer_missing': 'Calculez d\'abord l\'hydrofor.',
