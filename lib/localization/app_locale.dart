class AppLocale {
  ...
  static const Map<String, Map<String, String>> languages = {
    'TR': {
      ...
      'practical_floor_heating': 'Pratik Yerden Isıtma Hesabı',
      'pipe_diameter': 'Boru Çapı Hesabı',
      'calculate': 'HESAPLA',
      'clean': 'TEMİZLE',
      ...
      'floor_heating_area': 'Isıtılacak Alan (m²)',
      'floor_heating_modulation': 'Modülasyon',
      'floor_heating_modulation_tight': 'Sık aralık',
      'floor_heating_modulation_normal': 'Normal',
      'floor_heating_modulation_wide': 'Geniş',
      'floor_heating_pipe_diameter': 'PEX Boru Çapı (mm)',
      'floor_heating_screed': 'Şap Kalınlığı (cm)',
      'floor_heating_max_length': '1 kolektör ağzının max boru metrajı (m)',
      'floor_heating_collector_ports': 'Seçilen kolektör ağız sayısı',
      'floor_heating_pipe_length': 'Boru metrajı (m)',
      'floor_heating_capacity_kw': 'Hesaplanan ısıtıcı kapasitesi (kW)',
      'floor_heating_avg_heat': 'Ortalama verilen ısı (W/m²)',
      'floor_heating_total_heat_w': 'Toplam verilen ısı (W)',
      'floor_heating_total_heat_kcalh': 'Toplam verilen ısı (kcal/h)',
      'floor_heating_required_ports':
          'Alana göre gereken toplam kolektör ağız sayısı (adet)',
      'floor_heating_collector_count': 'Hesaplanan kolektör adedi (adet)',
      'floor_heating_collector_ports_per':
          'Hesaplanan 1 adet kolektörün ağız sayısı (N)',
      ...
      'bulk_pdf': 'Toplu PDF Oluştur',
      'export_selected': 'Seçilenleri PDF Yap',
      'selected_count': 'Seçildi',
      'calculation_report_title': 'Hesaplama Raporu',
      'record': 'Kayıt',
      ...
      'delta_t': 'ΔT',
      'pipe_diameter_mode': 'Hesap Modu',
      'pipe_mode_capacity': 'Kapasiteden Hesapla',
      'pipe_mode_flow': 'Debiden Hesapla',
      'pipe_mode_diameter': 'Çaptan Hesapla',
      'pipe_capacity': 'Kapasite',
      'pipe_flow': 'Debi',
      'pipe_diameter_input': 'Boru iç çapı',
      'pipe_velocity': 'Akışkan hızı v',
      'pipe_delta_t_radiator': '20 (Radyatör 90/70)',
      'pipe_delta_t_floor': '10 (Yerden 55/45)',
      'pipe_delta_t_cooling': '5 (Soğutma 7/12)',
      'pipe_result_diameter': 'Boru iç çapı',
      'pipe_result_flow_m3h': 'Debi (m³/h)',
      'pipe_result_flow_lh': 'Debi (L/h)',
      'pipe_result_flow_ls': 'Debi (L/s)',
      'pipe_result_capacity_kcalh': 'Kapasite (kcal/h)',
      'pipe_result_capacity_kw': 'Kapasite (kW)',
      'pipe_water_volume_title': 'Boru içindeki su miktarı',
      'pipe_length': 'Boru uzunluğu',
      'pipe_water_volume_m3': 'Hacim (m³)',
      'pipe_water_volume_l': 'Su miktarı (L)',
      ...
      'err_positive_value': '0’dan büyük olmalıdır.',
    ...
    'EN': {
      ...
      'practical_floor_heating': 'Practical Underfloor Heating',
      'pipe_diameter': 'Pipe Diameter Calculation',
      'calculate': 'CALCULATE',
      'clean': 'CLEAR',
      ...
      'floor_heating_area': 'Area to heat (m²)',
      'floor_heating_modulation': 'Modulation',
      'floor_heating_modulation_tight': 'Tight spacing',
      'floor_heating_modulation_normal': 'Normal',
      'floor_heating_modulation_wide': 'Wide spacing',
      'floor_heating_pipe_diameter': 'PEX pipe diameter (mm)',
      'floor_heating_screed': 'Screed thickness (cm)',
      'floor_heating_max_length': 'Max pipe length per manifold port (m)',
      'floor_heating_collector_ports': 'Selected manifold port count',
      'floor_heating_pipe_length': 'Pipe length (m)',
      'floor_heating_capacity_kw': 'Calculated heating capacity (kW)',
      'floor_heating_avg_heat': 'Average supplied heat (W/m²)',
      'floor_heating_total_heat_w': 'Total supplied heat (W)',
      'floor_heating_total_heat_kcalh': 'Total supplied heat (kcal/h)',
      'floor_heating_required_ports':
          'Required total manifold ports by area (count)',
      'floor_heating_collector_count': 'Calculated manifold count (count)',
      'floor_heating_collector_ports_per': 'Ports per manifold (N)',
      ...
      'bulk_pdf': 'Generate Batch PDF',
      'export_selected': 'Export Selected to PDF',
      'selected_count': 'Selected',
      'calculation_report_title': 'Calculation Report',
      'record': 'Record',
      ...
      'delta_t': 'ΔT',
      'pipe_diameter_mode': 'Calculation Mode',
      'pipe_mode_capacity': 'Calculate from Capacity',
      'pipe_mode_flow': 'Calculate from Flow',
      'pipe_mode_diameter': 'Calculate from Diameter',
      'pipe_capacity': 'Capacity',
      'pipe_flow': 'Flow',
      'pipe_diameter_input': 'Pipe inner diameter',
      'pipe_velocity': 'Fluid velocity v',
      'pipe_delta_t_radiator': '20 (Radiator 90/70)',
      'pipe_delta_t_floor': '10 (Underfloor 55/45)',
      'pipe_delta_t_cooling': '5 (Cooling 7/12)',
      'pipe_result_diameter': 'Pipe inner diameter',
      'pipe_result_flow_m3h': 'Flow (m³/h)',
      'pipe_result_flow_lh': 'Flow (L/h)',
      'pipe_result_flow_ls': 'Flow (L/s)',
      'pipe_result_capacity_kcalh': 'Capacity (kcal/h)',
      'pipe_result_capacity_kw': 'Capacity (kW)',
      'pipe_water_volume_title': 'Water inside the pipe',
      'pipe_length': 'Pipe length',
      'pipe_water_volume_m3': 'Volume (m³)',
      'pipe_water_volume_l': 'Water amount (L)',
      ...
      'err_positive_value': 'must be greater than 0.',
    ...
    'DE': {
      ...
      'practical_floor_heating': 'Praktische Fußbodenheizung',
      'pipe_diameter': 'Rohrdurchmesserberechnung',
      'calculate': 'BERECHNEN',
      'clean': 'LÖSCHEN',
      'search_hint': 'Suchen...',
      ...
      'floor_heating_area': 'Beheizte Fläche (m²)',
      'floor_heating_modulation': 'Modulation',
      'floor_heating_modulation_tight': 'Enger Abstand',
      'floor_heating_modulation_normal': 'Normal',
      'floor_heating_modulation_wide': 'Weiter Abstand',
      'floor_heating_pipe_diameter': 'PEX Rohrdurchmesser (mm)',
      'floor_heating_screed': 'Estrichdicke (cm)',
      'floor_heating_max_length':
          'Max. Rohrlänge je Verteilerabgang (m)',
      'floor_heating_collector_ports':
          'Gewählte Verteilerabgänge (Anzahl)',
      'floor_heating_pipe_length': 'Rohrlänge (m)',
      'floor_heating_capacity_kw': 'Berechnete Heizleistung (kW)',
      'floor_heating_avg_heat': 'Ø abgegebene Wärme (W/m²)',
      'floor_heating_total_heat_w': 'Gesamt abgegebene Wärme (W)',
      'floor_heating_total_heat_kcalh': 'Gesamt abgegebene Wärme (kcal/h)',
      'floor_heating_required_ports':
          'Erforderliche Gesamtzahl Verteilerabgänge (Anzahl)',
      'floor_heating_collector_count': 'Berechnete Verteileranzahl (Anzahl)',
      'floor_heating_collector_ports_per': 'Abgänge pro Verteiler (N)',
      ...
      'bulk_pdf': 'Batch-PDF erstellen',
      'export_selected': 'Ausgewählte als PDF',
      'selected_count': 'Ausgewählt',
      'calculation_report_title': 'Berechnungsbericht',
      'record': 'Eintrag',
      ...
      'delta_t': 'ΔT',
      'pipe_diameter_mode': 'Berechnungsmodus',
      'pipe_mode_capacity': 'Aus Kapazität berechnen',
      'pipe_mode_flow': 'Aus Durchfluss berechnen',
      'pipe_mode_diameter': 'Aus Durchmesser berechnen',
      'pipe_capacity': 'Kapazität',
      'pipe_flow': 'Durchfluss',
      'pipe_diameter_input': 'Innenrohrdurchmesser',
      'pipe_velocity': 'Strömungsgeschwindigkeit v',
      'pipe_delta_t_radiator': '20 (Heizkörper 90/70)',
      'pipe_delta_t_floor': '10 (Fußboden 55/45)',
      'pipe_delta_t_cooling': '5 (Kühlung 7/12)',
      'pipe_result_diameter': 'Innenrohrdurchmesser',
      'pipe_result_flow_m3h': 'Durchfluss (m³/h)',
      'pipe_result_flow_lh': 'Durchfluss (L/h)',
      'pipe_result_flow_ls': 'Durchfluss (L/s)',
      'pipe_result_capacity_kcalh': 'Kapazität (kcal/h)',
      'pipe_result_capacity_kw': 'Kapazität (kW)',
      'pipe_water_volume_title': 'Wassermenge im Rohr',
      'pipe_length': 'Rohrlänge',
      'pipe_water_volume_m3': 'Volumen (m³)',
      'pipe_water_volume_l': 'Wassermenge (L)',
      ...
      'err_positive_value': 'muss größer als 0 sein.',
    ...
    'FR': {
      ...
      'practical_floor_heating': 'Calcul pratique chauffage au sol',
      'pipe_diameter': 'Calcul du diamètre de tuyau',
      'calculate': 'CALCULER',
      'clean': 'EFFACER',
      ...
      'floor_heating_area': 'Surface à chauffer (m²)',
      'floor_heating_modulation': 'Modulation',
      'floor_heating_modulation_tight': 'Espacement serré',
      'floor_heating_modulation_normal': 'Normal',
      'floor_heating_modulation_wide': 'Espacement large',
      'floor_heating_pipe_diameter': 'Diamètre du tube PEX (mm)',
      'floor_heating_screed': 'Épaisseur de chape (cm)',
      'floor_heating_max_length':
          'Longueur max de tube par sortie de collecteur (m)',
      'floor_heating_collector_ports':
          'Nombre de sorties de collecteur choisi',
      'floor_heating_pipe_length': 'Longueur de tube (m)',
      'floor_heating_capacity_kw': 'Puissance de chauffage calculée (kW)',
      'floor_heating_avg_heat': 'Chaleur moyenne fournie (W/m²)',
      'floor_heating_total_heat_w': 'Chaleur totale fournie (W)',
      'floor_heating_total_heat_kcalh': 'Chaleur totale fournie (kcal/h)',
      'floor_heating_required_ports':
          'Nombre total de sorties requis par surface (unité)',
      'floor_heating_collector_count': 'Nombre de collecteurs calculé (unité)',
      'floor_heating_collector_ports_per':
          'Nombre de sorties par collecteur (N)',
      ...
      'bulk_pdf': 'Créer PDF groupé',
      'export_selected': 'Exporter la sélection',
      'selected_count': 'Sélectionné',
      'calculation_report_title': 'Rapport de calcul',
      ...
      'delta_t': 'ΔT',
      'pipe_diameter_mode': 'Mode de calcul',
      'pipe_mode_capacity': 'Calculer à partir de la capacité',
      'pipe_mode_flow': 'Calculer à partir du débit',
      'pipe_mode_diameter': 'Calculer à partir du diamètre',
      'pipe_capacity': 'Capacité',
      'pipe_flow': 'Débit',
      'pipe_diameter_input': 'Diamètre intérieur du tuyau',
      'pipe_velocity': 'Vitesse du fluide v',
      'pipe_delta_t_radiator': '20 (Radiateur 90/70)',
      'pipe_delta_t_floor': '10 (Plancher 55/45)',
      'pipe_delta_t_cooling': '5 (Refroidissement 7/12)',
      'pipe_result_diameter': 'Diamètre intérieur du tuyau',
      'pipe_result_flow_m3h': 'Débit (m³/h)',
      'pipe_result_flow_lh': 'Débit (L/h)',
      'pipe_result_flow_ls': 'Débit (L/s)',
      'pipe_result_capacity_kcalh': 'Capacité (kcal/h)',
      'pipe_result_capacity_kw': 'Capacité (kW)',
      'pipe_water_volume_title': 'Eau dans le tuyau',
      'pipe_length': 'Longueur du tuyau',
      'pipe_water_volume_m3': 'Volume (m³)',
      'pipe_water_volume_l': 'Quantité d’eau (L)',
      ...
      'err_positive_value': 'doit être supérieur à 0.',
