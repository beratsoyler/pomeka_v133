...
import 'kazan_tesisat_screen.dart';
...
class AppLocale {
  ...
  static const Map<String, Map<String, String>> languages = {
    'TR': {
      ...
      'err_velocity': 'Akışkan hızı 0 veya negatif olamaz.',
      'zones_title': 'Zonlar',
      'zones_results_title': 'Zon Sonuçları',
      'boiler_capacity_title': 'Kazan Kapasitesi',
      'building_dimensions': 'Bina Ölçüleri',
      'width': 'En',
      'length': 'Boy',
      'height': 'Yükseklik',
      'expansion_tanks': 'Genleşme Tankları',
      'system_type': 'Sistem Tipi',
      'system_type_floor': 'YERDEN ISITMA',
      'system_type_panel': 'PANEL RADYATÖR',
      'system_type_steel': 'ÇELİK RADYATÖR',
      'system_type_other': 'DİĞER',
      'collector_velocity': 'Kollektör Akışkan Hızı',
      'collector_title': 'Kollektör',
      'collector_diameter': 'Kollektör Boru İç Çapı',
      'expansion_results_title': 'Genleşme Tankı Sonuçları',
      ...
      'zone_velocity': 'Akışkan Hızı',
      'zone_flow': 'Debi',
      'zone_diameter': 'Boru İç Çapı',
    ...
    'EN': {
      ...
      'zones_title': 'Zones',
      'zones_results_title': 'Zone Results',
      'boiler_capacity_title': 'Boiler Capacity',
      ...
      'system_type_floor': 'FLOOR HEATING',
      'system_type_panel': 'PANEL RADIATOR',
      'system_type_steel': 'STEEL RADIATOR',
      'system_type_other': 'OTHER',
      'collector_velocity': 'Collector Velocity',
      'collector_title': 'Collector',
      'collector_diameter': 'Collector Inner Diameter',
      'expansion_results_title': 'Expansion Tank Results',
      ...
      'zone_flow': 'Flow',
      'zone_diameter': 'Pipe Inner Diameter',
    ...
    'DE': {
      ...
      'zones_title': 'Zonen',
      'zones_results_title': 'Zonenergebnisse',
      'boiler_capacity_title': 'Kesselleistung',
      'building_dimensions': 'Gebäudeabmessungen',
      'width': 'Breite',
      'length': 'Länge',
      'height': 'Höhe',
      'expansion_tanks': 'Ausdehnungsgefäße',
      'system_type': 'Systemtyp',
      'system_type_floor': 'FUSSBODENHEIZUNG',
      'system_type_panel': 'PANELHEIZKÖRPER',
      'system_type_steel': 'STAHLHEIZKÖRPER',
      'system_type_other': 'SONSTIGE',
      'collector_velocity': 'Sammler-Geschwindigkeit',
      'collector_title': 'Kollektor',
      'collector_diameter': 'Sammler-Innendurchmesser',
      'expansion_results_title': 'Ausdehnungsbehälter Ergebnisse',
      'open_tank': 'Offener Ausdehnungsbehälter',
      'closed_tank': 'Geschlossener Ausdehnungsbehälter',
      ...
      'zone_velocity': 'Geschwindigkeit',
      'zone_flow': 'Durchfluss',
      'zone_diameter': 'Rohrinnendurchmesser',
      'check_height': 'PRÜFEN'
    },
    'FR': {
      ...
      'zones_title': 'Zones',
      'zones_results_title': 'Résultats des zones',
      'boiler_capacity_title': 'Puissance chaudière',
      'building_dimensions': 'Dimensions du bâtiment',
      'width': 'Largeur',
      'length': 'Longueur',
      'height': 'Hauteur',
      'expansion_tanks': 'Vases d\'expansion',
      'system_type': 'Type de système',
      'system_type_floor': 'CHAUFFAGE AU SOL',
      'system_type_panel': 'RADIATEUR PANNEAU',
      'system_type_steel': 'RADIATEUR ACIER',
      'system_type_other': 'AUTRE',
      'collector_velocity': 'Vitesse collecteur',
      'collector_title': 'Collecteur',
      'collector_diameter': 'Diamètre intérieur du collecteur',
      'expansion_results_title': 'Résultats du vase d\'expansion',
